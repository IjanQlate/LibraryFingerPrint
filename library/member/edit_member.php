...
<?php $get_id = $_GET['id']; ?>
	...
	<form class="form-horizontal" method="POST" action="update_member.php" enctype="multipart/form-data">
		...
		<div class="control-group">
			...
			<div class="controls">
			<input type="text" id="username" value="<?php echo $row['username']; ?>" name="username"  placeholder="Username" required>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="inputPassword">Password:</label>
			<div class="controls">
			<input type="password" id="myInput" value="<?php echo $row['password']; ?>" name="password"  placeholder="Password" required>
