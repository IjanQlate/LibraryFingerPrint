	...
	mysqli_query($link,"update users set username='$username', password='$password' , firstname = '$firstname' , lastname = '$lastname'  ,user_type = '$user_type' where user_id='$user_id'")or die(mysqli_error($link)); ?>
	<script>
